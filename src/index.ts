...
export {
  ...
  type EmbeddingRecipeId,
  type EmbeddingDistanceMetric,
  type EmbeddingPooling,
  type EmbeddingOutputDtype,
  type EmbeddingRevisionPolicy,
  type EmbeddingNormalization,
  type PgvectorDistanceOperator,
  type PgvectorIndexOperatorClass,
  type PgvectorScoreConversion,
  type PgvectorMetricSpec,
  type MrlSupport,
